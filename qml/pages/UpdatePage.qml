    ...
    DragScrollArea {
        ...
        Rectangle {
            ...
            Column {
                ...
                Text { width: parent.width; text: "这里可以放置更新界面。网络请求和更新逻辑建议放在 Python 中，并通过安全信号暴露给 QML。"; color: Core.Theme.color.mutedText; font.pixelSize: Core.Theme.fontSize.body; wrapMode: Text.WordWrap }
